...
namespace app.UserControlsOperator
{
    public partial class UC_ОформитьЗаказ : UserControl
    {
        ...
        private bool FDDComboBoxSizes2 = true;
        private bool FDDComboBoxSizes3 = true;
        private bool FDDComboBoxProduct1 = true;
        private bool FDDComboBoxProduct2 = true;
        private bool FDDComboBoxProduct3 = true;
        private bool FDDComboBoxFabric1 = true;
        private bool FDDComboBoxFabric2 = true;
        private bool FDDComboBoxFabric3 = true;
        private DB DB;
    ...
    -- Процент отходов: отходы / общее количество ткани
((@длина * @ширина * @количество) - 

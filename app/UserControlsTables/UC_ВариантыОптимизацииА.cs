...
namespace app.UserControls
{
    public partial class UC_ВариантыОптимизацииА : UserControl
    {
        ...
        public UC_ВариантыОптимизацииА()
        {
            InitializeComponent();
            DB = new DB();
        ...
        private void RefreshDataGrid(DataGridView DGW)
        {
            ...
            string queryString = @"
            SELECT 
                ВариантыОптимизации.КодОптимизации, 
                ВариантыОптимизации.КодСотрудника, 
                Сотрудники.Фамилия AS ФамилияСотрудника, 
                ...
                ВариантыОптимизации.ДатаСоздания 
            FROM 
                ВариантыОптимизации 
            JOIN 
        ...
        private void UC_ВариантыОптимизацииА_Load(object sender, EventArgs e)
        {
            CreateColumns();
            RefreshDataGrid(DataGridViewOptimizationOptions);
            comboSearch();
        ...
        JOIN 
            Сотрудники ON ВариантыОптимизации.КодСотрудника = Сотрудники.КодСотрудника
        WHERE 
            CONCAT(Сотрудники.Фамилия, Ткани.Вид, Изделия.НазваниеИзделия, Размеры.НазваниеРазмер, ВариантыОптимизации.КоличествоИзделий, ВариантыОптимизации.КоличествоОтходов, ВариантыОптимизации.ПроцентОтходов, ВариантыОптимизации.ДатаСоздания) LIKE '%{searchTextBox.Text}%'";
    ...
    WHERE 
        ...
        AND (@Поиск IS NULL OR CONCAT(Сотрудники.Фамилия, Ткани.Вид, Изделия.НазваниеИзделия, Размеры.НазваниеРазмер, ВариантыОптимизации.КоличествоИзделий, ВариантыОптимизации.КоличествоОтходов, ВариантыОптимизации.ПроцентОтходов, ВариантыОптимизации.ДатаСоздания) LIKE '%' + @Поиск + '%')";
